...
use App\Http\Controllers\RadicadosController;
...
Route::group(['prefix' => 'empresa', 'middleware' => ['auth']], function () {
    ...
    Route::group(['prefix' => 'radicados'], function () {
        ...
        // Ruta temporal
        Route::get('find-clients', [RadicadosController::class, 'findClients']);
    });
    ...
    Route::group(['prefix' => 'contratos'], function () {
        ...
        Route::get('ejemplo', 'ContratosController@ejemplo')->name('contratos.ejemplo');
        Route::post('importar', 'ContratosController@cargando')->name('contratos.importar');
