            ...
            <tbody>
                <tr>
                    <td>
                        ...
                        <div style="width: 100%; background-color: {{$empresa->color}}; clear:both;  margin-top: 10px;">
                            <p style="color: white; margin: 2px; text-align: justify; padding: 5px;" class="">
                                Este contrato explica las condiciones para la prestación de los servicios entre usted y <b>{{$empresa->color->nombre}}</b>, por el que pagará mínimo mensualmente <b>$ _______</b>. Este contrato tendrá vigencia de ____ meses, contados a partir del <b>__/__/____</b>. El plazo máximo de instalación es de 15 días hábiles. Acepto que mi contrato se renueve sucesiva y automáticamente por un plazo igual al inicial <input checked="checked" type="checkbox"> *
                            </p>
                        </div>
                        ...
                        <div style="border: 1px  solid #000; margin-top: 5px; padding:2px; text-align: right;">
                            VALOR TOTAL <span style="background-color:silver;">&nbsp;&nbsp;&nbsp;{{$empresa->color->moneda}} {{ App\Funcion::Parsear($total_tv + $total_internet) }}&nbsp;&nbsp;&nbsp;</span>&nbsp;&nbsp;&nbsp;
                        </div>
                    ...
                    <td style="vertical-align:top;" width="50%">
                        ...
                        <p style="text-align: justify;" class="small">Cuando se presente indisponibilidad del servicio o este se suspenda a pesar de su pago oportuno, lo compensaremos en su próxima factura. Debemos cumplir con las condiciones de calidad definidas por la CRC.<br>Consúltelas en la página: {{ $empresa->color->web }}</p><br>
            ...
            <tbody>
                <tr>
                    <td style="vertical-align:top;" width="50%">
                        ...
                        <p style="text-align: justify;" class="small">
                            <u> {{ $contact->nombre }} {{ $contact->apellidos() }} </u>, identificado como aparece el pie de mi firma, por medio del presente escrito, manifiesto que he sido informado y autorizo <b>{{$empresa->color->nombre}}</b> para que:<br><br>
                            Actúe como responsable del Tratamiento de datos personales de los cuales soy titular y que, conjunta o separadamente podrán recolectar, usar y tratar mis datos personales conforme la Política de Tratamiento de Datos Personales de la Compañía disponible en <b>{{$empresa->color->web}}</b><br><br>
                            ...
                            Para cualquier inquietud o información adicional relacionada con el tratamiento de datos personales, puedo contactarme al correo electrónico {{$empresa->color->email }}<br><br>
                    ...
                    <td style="vertical-align:top;" width="50%">
                        ...
                        <p style="text-align: justify;" class="small">
                            Yo, <u> {{ $contact->nombre }} {{ $contact->apellidos() }} </u> identificado como aparece al pie de mi firma, obrando en mi propio nombre y/o en representación de: ____________________ AUTORIZO EXPRESA E IRREVOCABLEMENTE a <b>{{$empresa->color->nombre}}</b>, libre y voluntariamente, para que reporte, consulte y divulgue a cualquier operador y/o fuente de información legalmente establecido, toda la información referente a mi comportamiento como cliente que se relacione con el nacimiento, ejecución, modificación, liquidación y/o extinción de las obligaciones que se deriven del presente contrato, en cualquier tiempo, y que podrá reflejarse en las bases de datos de DATACREDIDO, CIFIN, COVINOC o de cualquier otro operador y/o fuente de información legalmente establecido. La permanencia de la información estará sujeta a los principios, términos y condiciones consagrados en la ley 1266 de 2008 y demás normas que lo modifiquen, aclaren o reglamenten. Así mismo, autorizo, expresa e irrevocablemente a <b>{{$empresa->color->nombre}}</b> para que consulte toda la información financiera, crediticia, comercial, de servicios y la proveniente de otros países, atinente a mis relaciones comerciales que tenga con el Sistema Financiero, comercial y de servicios, o de cualquier sector, tanto en Colombia como en el Exterior, en cualquier tiempo. PARÁGRAFO: La presente autorización se extiende para que <b>{{$empresa->color->nombre}}</b> pueda compartir información con terceros públicos o privados, bien sea que éstos ostenten la condición de fuentes de información, operadores de información o usuarios, con quienes EL CLIENTE tenga vínculos jurídicos de cualquier naturaleza, todo conforme a lo establecido en las normas legales vigentes dentro del marco del Sistema de Administración de Riesgos de Lavado de Activos y Financiación al Terrorismo SARLAFT de <b>{{$empresa->color->nombre}}</b>
                        </p>
                ...
                <tr>
                    <td style="vertical-align:top;" width="50%">
                        ...
                        <p style="text-align: justify;" class="small">
                            ...
                            <br><br>
                            - La cuantía será igual al monto de todas las sumas que, por cualquier concepto le esté debiendo a <b>{{$empresa->color->nombre}}</b> el día que sea llenado incluyendo en dicha cuantía el valor de aquellas obligaciones que se declaren se plazo vencido como anteriormente se autorizó.<br>
