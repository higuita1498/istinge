@extends('layouts.app')
@section('content')
	<form method="POST" action="{{ route('plantillas.envio_aviso') }}" style="padding: 2% 3%;" role="form" class="forms-sample" novalidate id="form-retencion">
	    @csrf
	    <div class="row">
        	...
        	<div class="col-md-3 form-group d-none" id="seleccion_manual">
