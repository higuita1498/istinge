                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        ...
                        <p class="text-left nomargin">
                            <a href="#" id="contacto">
                                <i class="fas fa-plus"></i> Nuevo Contacto rápido
                            </a>
                        </p>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <table class="table table-striped table-sm" id="table-form" width="100%">
                        ...
                        <tbody>
                        @if(isset($cotizacion))
                            @include('remisiones.includes.itemsCotizacion')
                        @else
                            <tr id="1">
                            <td class="no-padding">
            ...
            <div class="row" style="margin-top: 10%;">
                <div class="col-md-4 offset-md-8">
                    <table class="text-right widthtotal" id="totales">
                        @if(isset($itemsCotizacion))
                            @php $sub= 0; @endphp
                            @foreach($itemsCotizacion as $itemR)
                                <input type="hidden" value="{{$sub= $sub+$itemR->precio}}">
                            @endforeach
                        @endif
                        <tr>
                            <td width="40%">Subtotal</td>
                            <td>{{Auth::user()->empresa()->moneda}} <span id="subtotal">@if(isset($itemsCotizacion))
                                        {{App\Funcion::Parsear($sub)}} @else 0 @endif</span>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>Subtotal</td>
                            <td>{{Auth::user()->empresa()->moneda}} <span id="subsub">
                                    @if(isset($itemsCotizacion)){{App\Funcion::Parsear($sub)}} @else 0 @endif</span>
                            </td>
                        </tr>
                    </table>
                    <hr>
                    <table class="text-right widthtotal" style="font-size: 24px !important;">
                        <tr>
                            ...
                            @endphp
                            @if(isset($itemsCotizacion))
                                @foreach($itemsCotizacion as $itemT)
                                    <input type="hidden" value="{{$precio= $precio + $itemT->precio}}">
                                    <input type="hidden" value="{{$total= ($precio)}}">
