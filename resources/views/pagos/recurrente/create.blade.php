        ...
        <div class="row" style=" text-align: right;">
            <div class="col-md-5">
                <div class="form-group row">
                    <label class="col-sm-4 col-form-label">Bancodd <span class="text-danger">*</span></label>
                    <div class="col-sm-8">
            ...
            <div class="col-md-6 offset-md-1">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <select class="form-control selectpicker" name="beneficiario" id="beneficiario" title="Seleccione" data-live-search="true" data-size="5" onchange="factura_pendiente();" disabled>
                            @foreach($beneficiarios as $clien)
                                <option {{$gasto->beneficiario==$clien->id?'selected':''}} value="{{$clien->id}}">{{$clien->nombre}} - {{$clien->nit}}</option>
                            @endforeach
                        </select>

                        <input type="hidden" name="beneficiario" value="{{$gasto->beneficiario}}">
                    </div>
