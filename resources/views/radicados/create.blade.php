...
@section('content')
    ...
    <span id="vue-page">
        <radicados-create></radicados-create>
    </span>
    ...
    <form method="POST" action="{{ route('radicados.store') }}" style="padding: 2% 3%;" role="form" class="forms-sample"
        id="form-radicado">
        {{ csrf_field() }}
        <div class="row">
            <div class="col-md-4 form-group">
                ...
                <div class="input-group" id="selectApi">
                    <select class="form-control selectpicker" name="cliente" id="cliente" required=""
                        title="Seleccione" data-live-search="true" data-size="5" onchange="busqueda_detalles(this.value);">
                        @foreach ($clientes as $client)
                            <option value="{{ $client->id }}" {{ $cliente == $client->id ? 'selected' : '' }}>
        ...
        <div class="row" id="content" style="display: none;">
            ...
            <div class="col-md-4 form-group">
                ...
                <input type="text" class="form-control" id="ident" name="ident" readonly=""
                    value="{{ old('identificacion') }}" maxlength="20">
                <span class="help-block error">
            ...
            <div class="col-md-4 form-group contract">
                ...
                <input type="text" class="form-control" id="contrato" name="contrato" readonly=""
                    value="{{ old('contrato') }}" maxlength="200">
                <span class="help-block error">
            ...
            <div class="col-md-3 form-group">
                ...
                <select class="form-control selectpicker" name="servicio" id="servicio" required=""
                    title="Seleccione">
                    @foreach ($servicios as $servicio)
                        <option {{ old('servicio') == $servicio->id ? 'selected' : '' }} value="{{ $servicio->id }}">
            ...
            <div class="col-md-3 form-group">
                ...
                <select class="form-control selectpicker" name="estatus" id="estatus" required=""
                    title="Seleccione" onchange="searchDV(this.value)">
            ...
            <div class="col-md-3 form-group" id="div_tecnico" style="display:none;">
                ...
                <select class="form-control selectpicker" name="tecnico" id="tecnico" title="Seleccione">
                    @foreach ($tecnicos as $tecnico)
                        <option {{ old('tecnico') == $tecnico->id ? 'selected' : '' }} value="{{ $tecnico->id }}">
            ...
            <div class="col-md-3 form-group">
                ...
                <select class="form-control selectpicker" name="prioridad" id="prioridad" required=""
                    title="Seleccione">
            ...
            @if (Auth::user()->empresa()->oficina)
                <div class="form-group col-md-3">
                    ...
                    <select class="form-control selectpicker" name="oficina" id="oficina" required=""
                        title="Seleccione" data-live-search="true" data-size="5">
                        @foreach ($oficinas as $oficina)
                            <option value="{{ $oficina->id }}"
                                {{ $oficina->id == auth()->user()->oficina ? 'selected' : '' }}>{{ $oficina->nombre }}
                            </option>
                        @endforeach
                    </select>
                </div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.cliente.apellido2) {
                        $("#nombre").val('').val(data.cliente.nombre + ' ' + data.cliente.apellido1 + ' ' + data
                            .cliente.apellido2);
                    }
