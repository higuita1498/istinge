    				...
    				<tbody>
    					...
    					@if($radicado->adjunto)
    					    <tr id="tr_adjunto">
    							...
    							<td>
    								<a href="{{ public_path('adjuntos/documentos/'.$radicado->adjunto)}}" target="_blank" class="btn btn-outline-success btn-sm btn-icons" style="border-radius: 50%;" title="Ver Adjunto"><i class="fas fa-eye"></i>
