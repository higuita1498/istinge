...
<html lang="en">
    <head>
        ...
        <style>
            ...
            #tabla-contratos_wrapper .dt-buttons,#tabla-planes_wrapper .dt-buttons,#tabla-mikrotiks_wrapper .dt-buttons,#tabla-nodos_wrapper .dt-buttons,#tabla-aps_wrapper .dt-buttons,#tabla-grupos_wrapper .dt-buttons{
                float: right !important;
            }
            #tabla-contratos_length,#tabla-planes_length,#tabla-mikrotiks_length,#tabla-nodos_length,#tabla-aps_length,#tabla-grupos_length{
                margin: 1% 0 !important;
            }
            #tabla-contratos_wrapper .dt-buttons button,#tabla-planes_wrapper .dt-buttons button,#tabla-mikrotiks_wrapper .dt-buttons button,#tabla-nodos_wrapper .dt-buttons button,#tabla-aps_wrapper .dt-buttons button,#tabla-grupos_wrapper .dt-buttons button{
                color: #fff !important;
                background-color: #00ce68 !important;
                border-color: #00ce68 !important;
            }
            #tabla-contratos_wrapper .dt-buttons button:hover,#tabla-planes_wrapper .dt-buttons button:hover,#tabla-mikrotiks_wrapper .dt-buttons button:hover,#tabla-nodos_wrapper .dt-buttons button:hover,#tabla-aps_wrapper .dt-buttons button:hover,#tabla-grupos_wrapper .dt-buttons button:hover{
                color: #fff !important;
                background-color: #218838 !important;
                border-color: #1e7e34 !important;
            }
            #tabla-contratos_wrapper .dt-buttons button:nth-child(2),#tabla-planes_wrapper .dt-buttons button:nth-child(2),#tabla-mikrotiks_wrapper .dt-buttons button:nth-child(2),#tabla-nodos_wrapper .dt-buttons button:nth-child(2),#tabla-aps_wrapper .dt-buttons button:nth-child(2),#tabla-grupos_wrapper .dt-buttons button:nth-child(2){
                color: #fff !important;
                background-color: #e65251 !important;
                border-color: #e65251 !important;
            }
            #tabla-contratos_wrapper .dt-buttons button:nth-child(2):hover,#tabla-planes_wrapper .dt-buttons button:nth-child(2):hover,#tabla-mikrotiks_wrapper .dt-buttons button:nth-child(2):hover,#tabla-nodos_wrapper .dt-buttons button:nth-child(2):hover,#tabla-aps_wrapper .dt-buttons button:nth-child(2):hover,#tabla-grupos_wrapper .dt-buttons button:nth-child(2):hover{
                color: #fff !important;
        ...
        <div class="container-scroller">
            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <div class="whatsapp text-left">
                    <a href="https://api.whatsapp.com/send?phone=+573135774747&text=Hola Network Soft, necesito soporte para la empresa {{Auth::user()->rol > 1 ? Auth::user()->empresa()->nombre:''}}" target="_blank" title="Soporte vía Whatsapp">
