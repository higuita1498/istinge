@extends('layouts.app')
@section('content')
    <input type="hidden" id="valuefecha" value="{{date('Y-m-d')}}">
    <div class="row card-description">
        <div class="col-md-12 ">
            <h2><i class="fas fa-shopping-cart"></i> Reporte Diario de Ventas</h2>
            <p  class="card-description">Consulta el total de facturación y cantidad vendida por cada uno de tus items diario, sin importar si la factura de venta ya se pagó o no </p>
        </div>
    </div>
    <form id="form-reporte">
        ...
        <div class="row card-description">
            ...
            <div class="form-group col-md-6" style="    padding-top: 2%;">
                <button type="button" id="generar" class="btn btn-outline-secondary">Generar Reporte</button>
                <button type="button" id="" class="btn btn-outline-secondary" data-toggle="modal" data-target=".bd-example-modal-sm" >Exportar a Excel</button>
    ...
    @include('reportes.reporteDiario.modal')
    <input type="hidden" id="urlgenerar" value="{{route('reportes.diario')}}">
@endsection
