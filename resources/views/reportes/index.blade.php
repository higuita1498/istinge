...
@section('content')
    ...
    @else
        <div class="card-body">
                ...
                <div class="col-md-5 offset-md-1 reportes">
                    ...
                    <ul class="list-report">
                        @if (auth()->user()->rol != 8)
                            ...
                            <li><a href="{{ route('reportes.puntoVenta') }}">Reporte de Puntos de Ventas (Ganancias)</a>
                            </li>
                            <li><a href="{{ route('reportes.puntoVentaRecaudo') }}">Reporte de Puntos de Ventas
                                    (Recaudos)</a></li>
                        @endif
                    </ul>
                </div>
            ...
            <div class="row">
                <div class="col-md-5 offset-md-1 reportes">
                    <h3><i class="fa-solid fa-chart-line"></i> Contables</h3>
                    <ul class="list-report">
                        <li><a href="{{ route('reportes.balance') }}">Reporte de Balances</a></li>
                    </ul>
                </div>
                <div class="col-md-5 offset-md-1">
                    <h3><i class="fa-solid fa-briefcase me-1"></i> CRC</h3>
                    <div class="d-grid">
                        <a href="{{ route('reportes.formulario13') }}" class="btn btn-primary position-relative">
                            Formulario 1.3
