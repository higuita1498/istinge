...
@section('content')
    ...
    <div class="row card-description">
        <div class="col-md-12 ">
            <h2><i class="fas fa-shopping-cart"></i> Retenciones y IVA</h2>
            ...
            <div class="col-md-12 table-responsive">
                <table class="table table-striped table-hover " id="table-general">
                    ...
                    <tbody>
                        <tr>
                            <th colspan="3"></th>
                            <td>{{Auth::user()->empresa()->moneda}} {{App\Funcion::Parsear($totales['totalValorRetenido'])}}</td>
                            <td>{{Auth::user()->empresa()->moneda}} {{App\Funcion::Parsear($totales['totalIva'])}}</td>
                        </tr>
