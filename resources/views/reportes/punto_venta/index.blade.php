...
@section('content')
                ...
                <table class="table" id="">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                {{Auth::user()->empresa()->moneda}} {{App\Funcion::Parsear($movimiento->saldo())}}
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
    ...
    <input type="hidden" id="urlgenerar" value="{{route('reportes.puntoVenta')}}">
    <input type="hidden" id="urlexportar" value="{{route('exportar.puntoVenta')}}">
@endsection
