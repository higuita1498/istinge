    ...
    <form method="POST" action="{{ route('asignaciones.store') }}" style="padding: 2% 3%;" role="form" class="forms-sample" id="form-asignacion" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-md-3 form-group">
                ...
                <div class="col-md-3 form-group">
                    <label class="control-label" id="div_campo_h">Adjuntar audio</label>
                    <input type="file" class="form-control" name="archivo_de_audio" accept="audio/*" required id="adjunto_audio" name="adjunto_audio"  value="{{old('adjunto_audio')}}">
