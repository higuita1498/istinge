@extends('layouts.app')
@section('content')
	<form method="POST" action="{{ route('oficinas.store') }}" style="padding: 2% 3%;" role="form" class="forms-sample" novalidate id="form-retencion" >
	   @csrf
	   <div class="row">
	        ...
	        <div class="col-md-4 form-group">
	            ...
	            <input type="text" class="form-control" id="telefono" name="telefono"  value="{{old('telefono')}}" maxlength="200">
	            <span class="help-block error">
