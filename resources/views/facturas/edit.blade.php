                              ...
                              <tr id="forma{{$cont}}" fila="{{$cont}}">
                                <td  class="no-padding">
                                  ...
                                  <td class="monetario">
                                    ...
                                    <input type="number" required="" style="display: inline-block; width: 100%;" class="form-control form-control-sm"  value="{{$forma->debito}}" maxlength="24" id="precioformapago{{$cont}}" name="precioformapago[]" placeholder="Valor anticipo" onkeyup="total_linea_formapago()" required="" min="0">
                                  </td>
