	...
	<form method="POST" action="{{ route('pagosrecurrentes.store') }}" style="padding: 2% 3%;    " role="form" class="forms-sample" novalidate id="form-factura" >
  		...
  		<div class="row" style=" text-align: right;">
  			<div class="col-md-5">
                ...
                <div class="form-group row">
                    <label class="col-sm-4 col-form-label">Método de pago  <span class="text-danger">*</span></label>
                    <div class="col-sm-8">
                        <select class="form-control selectpicker" name="metodo_pago" id="metodo_pago" title="Seleccione" data-live-search="true" data-size="5" required="">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <textarea  class="form-control min_max_70" name="observaciones"></textarea>
                    </div>
                </div>
            </div>
            <div class="col-md-6 offset-md-1">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <select class="form-control selectpicker" name="tipo_gasto" id="tipo_gasto" title="Seleccione" data-live-search="true" data-size="5" required="">
                            @foreach($tipos_gastos as $tipo)
                            <option {{old('tipo_gasto')==$tipo->id?'selected':''}} value="{{$tipo->id}}">{{$tipo->nombre}}</option>
                            @endforeach
                        </select>
                    </div>
                    <span class="help-block error">
