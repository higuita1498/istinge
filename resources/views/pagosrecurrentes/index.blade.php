...
@section('content')
	...
	<div class="col-md-6" style="background: #80808061;border: 1px solid #80808061;">
		<div class="row">
	...
	<div class="col-md-5">
		...
		<div class="container-filtercolumn" >
			...
			<ul class="options-search-columns"  id="columnOptions">
				...
				<li><input type="button" class="btn btn-success btn-sm boton_ocultar_mostrar" value="Beneficiario"></li>
			...
			<tbody>
				@foreach($gastos as $gasto)
					<tr @if($gasto->nro==Session::get('gasto_id')) class="active_table" @endif>
						...
						<td><div class="elipsis-short">@if($gasto->beneficiario())<a href="{{route('contactos.show',$gasto->beneficiario()->id)}}" target="_blanck">{{$gasto->beneficiario()->nombre}}@endif</a></div></td>
						...
						<td>{{Auth::user()->empresa()->moneda}}{{App\Funcion::Parsear($gasto->total()->total)}} </td>
							...
							@if($gasto->estado_pago == 1)
							<td class="text-success">PROXIMO</td>
							@elseif($gasto->estado_pago == 2)
