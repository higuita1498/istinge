    ...
    <div style="background: #fff; padding-bottom: 2%;">
      ...
      <div style="padding: 2% 5%;">
        ...
        <ul style="list-style: none;">
          ...
          <li style="text-align: justify;">Tipo de Identificación <b>{{$data["tip_iden"]}}</b></li>
          <li style="text-align: justify;">Identificación <b>{{$data["nit"]}}</b></li>
          <li style="text-align: justify;">Tipo de Persona <b>{{$data["tipo_persona"]}}</b></li>
          <li style="text-align: justify;">Teléfono <b>{{$data["telefono"]}}</b></li>
          <li style="text-align: justify;">Dirección <b>{{$data["direccion"]}}</b></li>
