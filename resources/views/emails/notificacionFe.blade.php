...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>Solicitud de facturación electrónica en proceso</title>
                                        ...
                                        <tr bgcolor="#ffffff">
                                            <td style="padding:20px 30px">
                                                <div style="text-align:left;line-height:22px;font-family:Arial,Helvetica,sans-serif;font-size:15px;font-weight:normal;margin-top:0px">
                                                    Sr (a)  representante de <strong>{{Auth::user()->empresa()->nombre}}</strong>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr bgcolor="#ffffff">
                                            <td style="padding:0px 30px">
                                                <div style="text-align:left;line-height:22px;font-family:Arial,Helvetica,sans-serif;font-size:15px;font-weight:normal;margin-top:0px"> Estamos procesando su solicitud, se le notificará por correo electrónico cuando esta sea aprobada y habilitada para el siguiente paso.</div>
                                                <br>
                                            </td>
                                        </tr>
                                        <tr bgcolor="#ffffff">
                                            <td>
                                                <table align="center" style="width:80%;height:64px;margin:0 auto;font-size:9pt;font-family:Arial,Helvetica,sans-serif;border:none;background-color:#f0f0f0;color:#000">
                                                    <tbody>
                                                        <tr>
                                                            <td style="padding-right:10px;width:50%" align="center">La clave ingresada es: </td>
