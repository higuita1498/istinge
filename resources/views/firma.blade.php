        ...
        <div id="signature-pad" class="jay-signature-pad">
            ...
            <div class="signature-pad--footer txt-center">
                ...
                <div class="signature-pad--actions txt-center">
                    ...
                    <div>
                        <button type="button" class="button save" data-action="save-png">Guardar PNG</button>
                        <button type="button" class="button save" data-action="save-jpg">Guardar JPG</button>
                        <button type="button" class="button save" data-action="save-svg">Guardar SVG</button>
                    </div>
                </div>
            </div>
        </div>
