@extends('layouts.app')
@section('content')
	<form method="POST" action="{{ route('vendedores.store') }}" style="padding: 2% 3%;    " role="form" class="forms-sample" novalidate id="form-vendedores" >
   {{ csrf_field() }} 
  <div class="row">
    ...
    <div class="col-md-4 form-group">
      ...
      <input type="text" class="form-control"  id="identificacion" name="identificacion"  value="{{old('identificacion')}}" maxlength="50">
      <span class="help-block error">
