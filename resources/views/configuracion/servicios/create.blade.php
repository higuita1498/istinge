@extends('layouts.app')
@section('content')
	<form method="POST" action="{{ route('servicio.store') }}" style="padding: 2% 3%;    " role="form" class="forms-sample" novalidate id="form-servicio" >
   {{ csrf_field() }}
  <div class="row">
    ...
    <div class="col-md-4 form-group">
      ...
      <input type="number" class="form-control"  id="tiempo" name="tiempo" value="{{old('tiempo')}}" min="0">
      <span class="help-block error">
