...
<div class="container-fluid">
  <div class="card border-0 shadow-sm">
    <form method="POST" action="{{ route('numeraciones_nomina.store') }}" class="forms-sample" id="form-numeracion">
      <div class="card-body">
        @csrf
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-5">
            <select class="form-control selectpicker" name="tipo_nomina" id="tipo_nomina" title="Seleccione" data-live-search="true" data-size="5" required>
              <option value="1" {{old('tipo_nomina') == 1 ? 'selected' : ''}} >Nómina Electrónica</option>
              <option value="2" {{old('tipo_nomina') == 2 ? 'selected' : ''}} >Nómina de ajuste</option>
            </select>
            <span class="help-block error">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-5">
            <input type="text" class="form-control" id="inicio" name="inicio" required="" value="{{old('inicio')}}" maxlength="8" onkeypress="return event.charCode >= 48 && event.charCode <=57">
            <span class="help-block error">
