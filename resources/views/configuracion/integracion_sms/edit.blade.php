...
@section('content')
	<form method="POST" action="{{ route('integracion-sms.update', $servicio->id) }}" style="padding: 2% 3%;" role="form" class="forms-sample" novalidate id="form-banco" >
	    ...
	    <div class="row">
	        ...
	        <div class="col-md-4 form-group">
	            <label class="control-label">Nro Celular para pruebas <span class="text-danger">*</span> <a><i data-tippy-content="Indique el número de celular para enviar el SMS de prueba, de ser un destino en Colombia, indíquelo con el código de país (57XXXXXXXXX)" class="icono far fa-question-circle"></i></a></label>
