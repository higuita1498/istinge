@extends('layouts.app')
@section('content')
	<form method="POST" action="{{ route('numeraciones_equivalente.update', $numeracion->id) }}" style="padding: 2% 3%;    " role="form" class="forms-sample" novalidate id="form-numeracion" >
   @csrf
  <div class="row">
    ...
    <div class="col-md-2 form-group">
      ...
      <input type="text" class="form-control"  id="inicioverdadero" name="inicioverdadero"  required="" value="{{$numeracion->inicioverdadero}}" maxlength="12">
      <span class="help-block error">
    ...
    <div class="col-md-2 form-group">
      ...
      <input type="text" class="form-control"  id="inicio" name="inicio"  required="" value="{{$numeracion->inicio}}" maxlength="12">
      <span class="help-block error">
    ...
    <div class="col-md-2 form-group">
      ...
      <input type="text" class="form-control"  id="final" name="final"   value="{{$numeracion->final}}" maxlength="8">
      <span class="help-block error">
