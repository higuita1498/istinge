...
use App\Model\Gastos\GastosRecurrentesCategoria; use App\Model\Gastos\GastosRecurrentes;
...
class PagosRecurrentesController extends Controller 
{
  ...
  {
    view()->share(['seccion' => 'gastos', 'subseccion' => 'pagosrecurrentes', 'title' => 'Programación de Pagos', 'icon' =>'fas fa-minus']);
  }
  ...
  public function create(){
    ...
    return view('pagosrecurrentes.create')->with(compact('beneficiarios', 'categorias', 'impuestos', 'bancos', 'metodos_pago'));

  }

   /*.........................................
    Comprobamos los estados de los pagos reccurentes cada vez que la persona entre a pagos recurrentes
    ...........................................*/
  ...
  public function store(Request $request)
  {
    ...
    /*...............................................................................
    Desarrollo para que no se dupliquen registros con un tiempo de 10 segundos
    .................................................................................*/
...
//Si el tiempo es de menos de 10 segundos mandamos al listado general
    ...
    /*...............................................................................
    Fin Desarrollo para que no se dupliquen registros con un tiempo de 10 segundos
    .................................................................................*/
  ...
  public function edit($id){
    ...
    if ($gasto) {  
      ...
      $categorias=Categoria::where('empresa',Auth::user()->empresa)->whereNull('asociado')->get();
      $impuestos = Impuesto::where('empresa',Auth::user()->empresa)->orWhere('empresa', null)->Where('estado', 1)->get();
      return view('pagosrecurrentes.edit')->with(compact('gasto', 'items', 'beneficiarios', 'categorias', 'impuestos', 'bancos', 'metodos_pago')); 
    }
    return redirect('empresa/pagosrecurrentes')->with('success', 'No existe un registro con ese id');
  }
  ...
  public function ingreso($gasto)
  {
      ...
      return view('pagos.recurrente.create')->with(compact('gasto', 'items', 'beneficiarios',
          'categorias', 'impuestos', 'bancos', 'metodos_pago', 'retenciones', 'fecha_actual'));
  ...
  public function pagar(Request $request)
  {
      ...
      $gasto->fecha=Carbon::parse($request->fecha)->format('Y-m-d');
      $gasto->observaciones=mb_strtolower($request->observaciones);
      //$gasto->fk_gastorecurrente = $gastoRecurrente->id;
      $gasto->save();
      ...
      $retencion='fact'.$gasto->id.'_retencion';
      $precio_reten='fact'.$$gasto->id.'_precio_reten';
      //Retenciones
  ...
  public function imprimir($id)
  {
      ...
      $gastoR = GastosRecurrentes::select('*')
      ...
      $gasto = Gastos::where('empresa',Auth::user()->empresa)
          ->where('tipo', 5)
          ->where('nro', $id)
          ->first();
