...
class Contacto extends Model
{
    ...
    protected $fillable = [
        ...
        'tipo_persona','responsableiva','plan','contrato', 'serial_onu', 'imgA', 'imgB', 'imgC', 'imgD', 'fecha_contrato', 'referencia_asignacion','boton_emision','monitoreo','refiere','combo_int_tv','referencia_1','referencia_2','cierra_venta','usuario_wifi','contrasena_wifi'
    ];
