...
<form method="post" action="{{ route('nomina.liquidar.guardar') }}">
    @csrf
        ...
        <div class="col-6">
            ...
            <div class="form-group">
                ...
                <div class="form-check">
                    <input class="form-check-input liquidar" type="radio" name="isCausal" id="isCausal1" value="1" checked>
                    <label class="form-check-label" for="isCausal1">
                      SI
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input liquidar" type="radio" name="isCausal" id="isCausal2" value="0">
            ...
            <div class="form-group">
                ...
                <div class="form-check">
                    <input class="form-check-input liquidar" type="radio" name="isPrueba" id="isPrueba1" value="1">
                    <label class="form-check-label" for="isPrueba1">
                      SI
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input liquidar" type="radio" name="isPrueba" id="isPrueba2" checked value="0">
    ...
    <div class="row">
        ...
        <div class="col-6">
            ...
            <div class="form-group col-md-12">
                ...
                <input type="text" class="form-control liquidar" name="salarioBase" id="salarioBase" maxlength="200" value="{{ number_format($salarioBase) }}" required="">
                <span class="help-block error">
            ...
            <div class="form-group col-md-12">
                ...
                <input type="text" class="form-control liquidar" name="cesantias" id="cesantias" maxlength="200" value="{{ number_format($cesantias) }}" required="">
                <span class="help-block error">
            ...
            <div class="form-group col-md-12">
                ...
                <input type="text" class="form-control liquidar" name="prima" id="prima" maxlength="200" value="{{ number_format($prima) }}" required="">
                <span class="help-block error">
        ...
        <div class="col-6">
            ...
            <div class="form-group">
                ...
                <div class="form-check">
                    <input class="form-check-input liquidar" type="radio" name="isIncluirDominicales" id="isIncluirDominicales1" value="1">
                    <label class="form-check-label" for="isIncluirDominicales1">
                      SI
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input liquidar" type="radio" name="isIncluirDominicales" id="isIncluirDominicales2" checked value="0">
    ...
    <div class="row">
        ...
        <div class="col-6">
            ...
            <div class="form-group col-md-12">
                ...
                <input type="text" class="form-control liquidar" name="otrosIngresos" id="otrosIngresos" maxlength="200" min="0" value="0" required="">
                <span class="help-block error">
        ...
        <div class="col-6">
            ...
            <div class="form-group col-md-12">
                ...
                <input type="text" class="form-control liquidar" name="valorPrestamos" id="valorPrestamos" maxlength="200" min="0" value="0" required="">
                <span class="help-block error">
            ...
            <div class="form-group col-md-12">
                ...
                <input type="text" class="form-control liquidar" name="otrasDeducciones" id="otrasDeducciones" maxlength="200" min="0" value="0" required="">
                <span class="help-block error">
...
<div class="row">
    ...
    <div class="col-6">
        ...
        <div class="row">
            <div class="col-3 m-5">
                <button type="submit" class="btn btn-success">Liquidar Persona</button>
            </div>
